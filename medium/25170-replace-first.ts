...
type ReplaceFirst<T extends readonly unknown[], S, R, Result extends readonly unknown[] = [], Flag extends boolean = false> = T extends [infer F, ...infer Rest]
    ? Flag extends true
        ? [...Result, ...T]
        : F extends S
            ? ReplaceFirst<Rest, S, R, [...Result, R], true>
