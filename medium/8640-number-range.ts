...
type NumberRange<L extends number, H extends number, Result extends number[] = [], Count extends number[] = [], Flag extends boolean = false> = Flag extends false
    ? Count['length'] extends L
        ? NumberRange<L, H, [...Result, Count['length']], [...Count, 1], true>
        : NumberRange<L, H, Result, [...Count, 1]>
    : Count['length'] extends H
        ? [...Result, Count['length']][number]
        : NumberRange<L, H, [...Result, Count['length']], [...Count, 1], true>;
