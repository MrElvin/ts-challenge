...
type Without<T, U, Result extends unknown[] = []> = T extends [infer F, ...infer Rest]
    ? F extends (U extends unknown[] ? U[number] : U) ? Without<Rest, U, Result> : Without<Rest, U, [...Result, F]>
    : Result;
